...
function ComingSoon() {
  return (
    <div className="flex flex-col items-center justify-center py-24 text-constructa-secondaryText gap-3">
      <div className="w-12 h-12 rounded bg-constructa-surface flex items-center justify-center">
        <span className="text-2xl">🚧</span>
      </div>
      <p className="text-sm font-semibold text-constructa-text">Configuración</p>
      <p className="text-xs">Esta sección estará disponible próximamente.</p>
    </div>
  );
}
