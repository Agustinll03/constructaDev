...
const config: Record<TaskStatus, { label: string; style: string }> = {
  pendiente:   { label: "Pendiente",    style: "bg-amber-100  text-amber-800  border-amber-200" },
  en_progreso: { label: "En progreso",  style: "bg-orange-100 text-orange-800 border-orange-200" },
  bloqueada:   { label: "Bloqueada",    style: "bg-red-100    text-red-700    border-red-200" },
  en_revision: { label: "En revisión",  style: "bg-blue-100   text-blue-700   border-blue-200" },
